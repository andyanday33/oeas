...
class StudentExamAccessForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['student'].queryset = OEAUser.objects.filter(user_type=UserTypes.STUDENT)

    def clean_student(self):
        student = self.cleaned_data['student']
        if student is None or student == 'Unknown':
                raise forms.ValidationError("Student can't be empty")
        return student
