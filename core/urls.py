...
urlpatterns = [
    ...
    path('i/exams/<int:exam_pk>/score/', score_list_view , name='exam_scores'),
    path('i/exams/<int:exam_pk>/students/', add_student_to_exam_view, name='add_student_to_exam'),
    path('i/exams/<int:exam_pk>/student/<int:student_pk>/delete/', delete_student_exam_access_view, name='delete_student_exam_access_view'),
